# File: model_configs/sv_model.py
# YOLOX-S with P2 feature level for SV dataset (1024x500)
...
# === DATASET CONFIGURATION (SV ONLY) ===
dataset_type = 'CocoDataset'
data_root = 'SV_dataset_processed/'
...
# Training dataloader - optimized for GTX 1080Ti
train_dataloader = dict(
    batch_size=3,  # Conservative for 11GB VRAM with large images
    num_workers=4,
